...
export const projectsData: Project[] = [
  {
    ...
    title: "Dozylab",
    description:
      "A product venture where I own the end-to-end technical delivery — WordPress site design, server configuration, and infrastructure management. Currently leading the transition to a headless Next.js frontend, including API integration, deployment, and backend setup. I also drive the UI/UX design, customer experience, vendor sourcing, brand identity, and packaging.",
...
export default MyComponent;`,
...

  {
    ...
    title: "Atlasbase",
    description:
      "A comprehensive online learning platform for NSW Selective and OC Exam preparation. Re-engineered from WordPress to a scalable and interactive platform using Next.js. It integrates custom functionalities to deliver interactive practice exams and a seamless user experience, mirroring the official test environment.",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS"],
    link: "https://atlasbase.app/",
